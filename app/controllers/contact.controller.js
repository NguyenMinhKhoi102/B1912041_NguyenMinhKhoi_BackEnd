...
exports.findAll = async (req, res, next) => {
    ...
    try {
        ...
        return next(
            new ApiError(500, "An error ocurred while retrieving the contact")
        )
    }
...
exports.deleteAll = async (req, res, next) => {
    try {
        ...
        return next(
            new ApiError(500, "An error ocurred while removing all contacts")
        );
    }
};
...
exports.findAllFavorite = async (_req, res, next) => {
    try {
        ...
        return next(
            new ApiError(500, "An error ocurred while retriving favorite the contacts")
        );
    }
};